{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kwin"."PoloniumCycleEngine" = "Meta+|\\,none";
      "kwin"."PoloniumFocusAbove" = "Meta+K\\,none";
      "kwin"."PoloniumFocusBelow" = "Meta+J\\,none";
      "kwin"."PoloniumFocusLeft" = "Meta+H\\,none";
      "kwin"."PoloniumFocusRight" = "none";
      "kwin"."PoloniumInsertAbove" = "Meta+Shift+K\\,none";
      "kwin"."PoloniumInsertBelow" = "Meta+Shift+J\\,none";
      "kwin"."PoloniumInsertLeft" = "Meta+Shift+H\\,none";
      "kwin"."PoloniumInsertRight" = "Meta+Shift+L\\,none";
      "kwin"."PoloniumResizeAbove" = "Meta+Ctrl+K\\,none";
      "kwin"."PoloniumResizeBelow" = "Meta+Ctrl+J\\,none";
      "kwin"."PoloniumResizeLeft" = "Meta+Ctrl+H\\,none";
      "kwin"."PoloniumResizeRight" = "Meta+Ctrl+L\\,none";
      "kwin"."PoloniumRetileWindow" = "Meta+Shift+Space\\,none";
      ...
      "kwin"."view_zoom_in" = ["" "Meta++\\,Meta++" "Meta+\x3d\\,Zoom In"];
